...
<%
// パラメータの取得
String resultPdf = (String) request.getAttribute( "resultPdf" );
...
<body onLoad="document.form2.num.focus()">
	<div align="center">
		<div>処理が完了しました</div>
		<button type="button"  onclick="check()" value=""/>保存</button>
		<a href="/pdfTest/html/index.html">もどる</a>
		<br/><br/>
        <!--
        <object data="<%= resultPdf %>" type="application/pdf" width="600" height="600"></object>
        <object data="file:///D:/pdf/testPdf.pdf" type="application/pdf" width="600" height="1000"></object>
		-->
		<br/>
		<br/>
	</div>
