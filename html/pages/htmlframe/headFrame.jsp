		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="nav_target">
				...
				<ul class="nav navbar-nav">
					<!-- 入庫 -->
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">入庫管理<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">入庫一覧</a></li>
							<li><a href="#">入庫追加</a></li>
						</ul></li>
					<!-- 出庫 -->
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">出庫管理<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">出庫一覧</a></li>
							<li><a href="#">出庫追加</a></li>
						</ul></li>
